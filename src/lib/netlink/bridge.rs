...
pub(crate) fn parse_bridge_info(infos: &[InfoBridge]) -> BridgeInfo {
    ...
    for info in infos {
        ...
        // InfoBridge::FdbFlush is only used for changing bridge
            ...
            bridge_info.multicast_router = (*d).into();
